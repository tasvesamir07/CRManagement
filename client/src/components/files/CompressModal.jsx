...
export default function CompressModal({ show, onClose, selectedFileIds, currentFolderId, onCompressed }) {
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input type="text" placeholder="archive.zip" value={compressArchiveName} onChange={(e) => setCompressArchiveName(e.target.value)} className="w-full px-3 py-2 text-sm border border-hairline rounded bg-canvas text-ink focus:outline-none focus:border-primary transition-colors font-sans" />
            </div>
          </div>
