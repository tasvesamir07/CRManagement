...
export default function CreateFolderModal({ show, onClose, courses, onCreated }) {
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input type="text" placeholder="e.g. Shared Documents, Assignment Instructions" value={newFolderName} onChange={(e) => setNewFolderName(e.target.value)} className="w-full px-3 py-2 text-sm border border-hairline rounded-sm bg-canvas text-ink placeholder-ink-mute/50 focus:outline-none focus:border-primary transition-colors" />
            </div>
            <div>
              ...
              <select value={newFolderCourseId} onChange={(e) => setNewFolderCourseId(e.target.value)} className="w-full px-3 py-2 text-sm border border-hairline rounded-sm bg-canvas text-ink focus:outline-none focus:border-primary transition-colors">
