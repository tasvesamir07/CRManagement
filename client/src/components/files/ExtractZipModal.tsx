...
interface ExtractZipModalProps {
  show: boolean;
  file: FileItem | null;
  onClose: () => void;
  currentFolderId: string | null;
  onExtracted?: (removedFileId: string | null) => void;
}

export default function ExtractZipModal({ show, file, onClose, currentFolderId, onExtracted }: ExtractZipModalProps) {
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2.5 pt-2 font-sans">
              <input type="checkbox" id="delete-original-zip" checked={deleteOriginalZip} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDeleteOriginalZip(e.target.checked)} className="accent-primary w-4 h-4 cursor-pointer rounded-sm" />
