...
interface ChannelCardProps {
  ...
  courseDefaults: Record<string, string[]>;
  courses: Course[];
  settingDefault: string | null;
  onEdit: (platform: Platform) => void;
  onDelete: (id: string) => void;
  onSetDefault: (platformId: string, courseId: string) => void;
}

const ChannelCard = ({ platform, waStatus, tgStatus, messengerStatus,
  courseDefaults, courses, settingDefault, onEdit, onDelete, onSetDefault }: ChannelCardProps) => {
  ...
  const isDefaultForCourse = (platformId: string, courseId: string): boolean => {
