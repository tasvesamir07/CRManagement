...
export const STANDARD_SLOTS_24 = [
...
export const formatTimeRange = (start24, end24) => {
  const to12h = (timeStr) => {
    if (!timeStr) return '';
...
export const getSortedSlots = (routines) => {
...
export const getActiveDays = (routines) => {
...
export const getCellRoutines = (routines, slot, day) => {
