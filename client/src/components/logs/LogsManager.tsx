                      ...
                      <tr key={log.id} className="hover:bg-canvas-soft/30 transition-colors">
                        ...
                        <td className="py-3 px-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button
                              onClick={(e: React.MouseEvent) => handleDeleteLog(log.id, e)}
              ...
              {logs.map((log: LogEntry) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isExpanded && (
                      <div className="mt-3 pt-3 border-t border-hairline-cool/40 space-y-3 text-xs" onClick={(e: React.MouseEvent) => e.stopPropagation()}>
                        <div>
