...
const Profile = () => {
  ...
  const handleDisable2FA = async () => {
    ...
    try {
      ...
      const updatedUser = { ...user, two_factor_enabled: false, two_factor_secret: null as string | null };
      setUser(updatedUser);
      localStorage.setItem('cr_user', JSON.stringify(updatedUser));
        ...
        {user.two_factor_enabled && (
          <div className="space-y-4">
            ...
            <PasswordInput
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => setDisable2FAPassword(e.target.value)}
