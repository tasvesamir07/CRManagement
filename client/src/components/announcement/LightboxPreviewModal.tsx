...
interface LightboxPreviewModalProps {
  previewFile: UploadedFile | null;
  previewUrl: string | null;
  previewLoading: boolean;
  previewTextContent: string;
  previewTextError: boolean;
  onClose: () => void;
}

export default function LightboxPreviewModal({
  previewFile, previewUrl, previewLoading, previewTextContent, previewTextError, onClose
}: LightboxPreviewModalProps) {
