...
export default function TopicsEditor({ topics, setTopics, currentTopic, setCurrentTopic }: TopicsEditorProps) {
  ...
  return (
    <div>
      ...
      <div className="flex gap-2 mb-2">
        <input type="text" value={currentTopic} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setCurrentTopic(e.target.value)} onKeyDown={(e: React.KeyboardEvent<HTMLInputElement>) => { if (e.key === 'Enter') { e.preventDefault(); addTopic(); } }}
