          ...
          <table className="min-w-full divide-y divide-hairline">
            <thead className="bg-canvas-soft">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-ink-mute uppercase">Batch</th>
            ...
            <tbody className="divide-y divide-hairline">
              {students.map((s) => (
                <tr key={s.id} className="hover:bg-canvas-soft transition-colors">
                  ...
                  <td className="px-4 py-3 text-sm text-ink-mute">{s.batch || '-'}</td>
                  <td className="px-4 py-3 text-sm text-ink-mute">{s.section || '-'}</td>
